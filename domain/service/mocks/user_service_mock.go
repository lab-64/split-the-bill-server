...
var (
	...
	MockUserUpdate                 func(requesterID uuid.UUID, id uuid.UUID, user dto.UserInput, file []byte) (dto.UserCoreOutput, error)
...
func (u UserServiceMock) Update(requesterID uuid.UUID, id uuid.UUID, user dto.UserInput, file []byte) (dto.UserCoreOutput, error) {
