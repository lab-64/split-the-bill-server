	...
	tests := []struct {
	...
	}{
		{
			...
			mock: func() {
				...
				dbMock.ExpectExec(`INSERT INTO "users"`).
					WithArgs(TestUser.ID, sqlmock.AnyArg(), sqlmock.AnyArg(), uuid.Nil, TestUser.Email, "", "").
		...
		},
		{
			...
			mock: func() {
				dbMock.ExpectBegin()
				dbMock.ExpectExec(`INSERT INTO "users"`).
					WithArgs(TestUserWithEmptyEmail.ID, sqlmock.AnyArg(), sqlmock.AnyArg(), uuid.Nil, TestUserWithEmptyEmail.Email, "", "").
